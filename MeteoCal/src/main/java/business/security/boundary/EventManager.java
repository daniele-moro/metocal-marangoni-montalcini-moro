...
public class EventManager {
     ...
     * @throws DateConsistencyException Exception in case of overlapping or inconsitent date
    ...
    /**
     * This method add an invitation related to the event passed to the user passed
